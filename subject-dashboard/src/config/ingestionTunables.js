...
// backend IngestionTuning contract exactly and are shared by the per-subject concurrency-overrides editor.
// Labels/tips are resolved via i18n keys (`processing.fields.<key>` / `processing.tips.<key>`).

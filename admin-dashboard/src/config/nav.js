...
export const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { section: 'ingestion-live', labelKey: 'nav.ingestionLive', icon: 'play', tip: 'Live pipeline view: which documents are running which step right now, which steps are waiting for a slot, and what is queued to start — with time in each state.' },
...
export const SECTION_META = {
  ...
  'ingestion-live': { titleKey: 'live.title', subtitleKey: 'live.subtitle' },

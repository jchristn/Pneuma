...
function AnalyticsView() {
  ...
  const load = useCallback(async () => {
    ...
    catch (err) { setError(err?.message || 'Failed to load analytics'); setReport(null); }
  ...
  return (
    <div>
      ...
      <div className="filter-bar">
        <div className="field">
          <label htmlFor="an-subject">{t('analytics.subject', 'Subject')}</label>
        ...
        <div className="field">
          <label htmlFor="an-days">{t('analytics.timeframe', 'Timeframe')}</label>
          <select id="an-days" value={days} onChange={(e) => setDays(Number(e.target.value))}>

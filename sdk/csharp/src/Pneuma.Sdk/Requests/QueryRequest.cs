namespace Pneuma.Sdk.Requests
{
    ...
    public class QueryRequest
    {
        ...
        /// <summary>
        /// Optional per-request facet filter (labels/tags). Merged with the subject's default filter (union of
        /// required and excluded), so a request narrows — never widens — the subject default.
        /// </summary>

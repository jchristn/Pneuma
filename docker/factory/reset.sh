...
echo "(Postgres, LiteGraph, Less3, DocumentAtom, Partio, Verbex, Ollama,"
...
mkdir -p "$DOCKER_DIR/documentatom" "$DOCKER_DIR/litegraph" "$DOCKER_DIR/partio" "$DOCKER_DIR/verbex"
...
cp -f "$FACTORY_DIR/verbex/verbex.json" "$DOCKER_DIR/verbex/verbex.json"

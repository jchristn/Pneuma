...
Use the Compose stack from the repository rather than running this image alone — the server depends on PostgreSQL, LiteGraph, DocumentAtom, and RecallDB.

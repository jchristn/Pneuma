                ...
                new
                {
                    ...
                    inputSchema = new
                    {
                        ...
                        properties = new
                        {
                            ...
                            embeddingModel = new { type = "string", description = "embedding endpoint id used to vectorize this subject's content and queries. Required before links can be ingested or questions answered." },
                            inferenceModel = new { type = "string", description = "completion endpoint id used for this subject's ingestion inference and answer generation. Required before links can be ingested or questions answered." },
                            rerankingModel = new { type = "string", description = "Optional completion endpoint id used to re-rank retrieved passages before answering. Null/omitted disables reranking." },
                            promptRewriteModel = new { type = "string", description = "Optional completion endpoint id used to rewrite the question into a retrieval query. Null/omitted disables prompt rewrite." },
                ...
                new
                {
                    ...
                    inputSchema = new
                    {
                        ...
                        properties = new
                        {
                            ...
                            embeddingModel = new { type = "string", description = "embedding endpoint id for this subject." },
                            inferenceModel = new { type = "string", description = "completion endpoint id for this subject's inference/answering." },
                            rerankingModel = new { type = "string", description = "completion endpoint id for reranking (empty string clears it)." },
                            promptRewriteModel = new { type = "string", description = "completion endpoint id for prompt rewrite (empty string clears it)." },

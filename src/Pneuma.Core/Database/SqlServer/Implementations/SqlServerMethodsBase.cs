namespace Pneuma.Core.Database.SqlServer.Implementations
{
    ...
    /// <summary>
    /// Shared base for SQL Server method implementations. Holds the driver reference and query helpers.
    /// </summary>
    internal abstract class SqlServerMethodsBase
    {
        ...
        protected SqlServerMethodsBase(DatabaseDriverBase db)
        {

namespace Pneuma.Core.Database.SqlServer.Implementations
{
    ...
    /// <summary>SQL Server persisted chat-turn performance-event methods.</summary>
    internal class ChatTurnPerfEventMethods : SqlServerMethodsBase, IChatTurnPerfEventMethods
    {

namespace Pneuma.Core.Database.SqlServer.Implementations
{
    ...
    /// <summary>SQL Server credential scope assignment methods.</summary>
    internal class CredentialScopeAssignmentMethods : SqlServerMethodsBase, ICredentialScopeAssignmentMethods
    {

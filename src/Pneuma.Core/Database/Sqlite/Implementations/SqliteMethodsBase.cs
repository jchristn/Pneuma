namespace Pneuma.Core.Database.Sqlite.Implementations
{
    ...
    /// <summary>
    /// Shared base for SQLite method implementations. Holds the driver reference and query helpers.
    /// </summary>
    internal abstract class SqliteMethodsBase
    {
        ...
        protected SqliteMethodsBase(DatabaseDriverBase db)
        {

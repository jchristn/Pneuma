namespace Pneuma.Core.Database.Sqlite.Implementations
{
    ...
    /// <summary>SQLite credential scope assignment methods.</summary>
    internal class CredentialScopeAssignmentMethods : SqliteMethodsBase, ICredentialScopeAssignmentMethods
    {

namespace Pneuma.Core.Database.Postgresql.Implementations
{
    ...
    /// <summary>
    /// Shared base for PostgreSQL method implementations. Holds the driver reference and query helpers.
    /// </summary>
    internal abstract class PostgresqlMethodsBase
    {
        ...
        protected PostgresqlMethodsBase(DatabaseDriverBase db)
        {

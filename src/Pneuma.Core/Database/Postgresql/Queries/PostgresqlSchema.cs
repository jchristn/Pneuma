namespace Pneuma.Core.Database.Postgresql.Queries
{
    ...
    /// <summary>
    /// PostgreSQL schema definition, expressed as ordered, idempotent migrations.
    /// </summary>
    internal static class PostgresqlSchema
    {
        ...
        internal static List<SchemaMigration> Migrations
        {
            get
            {
                ...
                {
                    "ALTER TABLE chatturns ADD COLUMN IF NOT EXISTS performancejson TEXT;",
                    "ALTER TABLE chatturns ADD COLUMN IF NOT EXISTS performanceschemaversion INTEGER NOT NULL DEFAULT 0;",
                    "CREATE TABLE IF NOT EXISTS chatturnperfevents (" +
                        ...
                        "durationms DOUBLE PRECISION, timetofirsttokenms DOUBLE PRECISION, " +
        ...
        private static List<string> InitialStatements()
        {
            return new List<string>
            {
                ...
                "CREATE TABLE IF NOT EXISTS requesthistory (" +
                    ...
                    "statuscode INTEGER, durationms DOUBLE PRECISION, sourceip TEXT, requestheaders TEXT, requestbody TEXT, " +
                    "requestbodybytes BIGINT, requestbodytruncated INTEGER, responseheaders TEXT, responsebody TEXT, " +
                    "responsebodybytes BIGINT, responsebodytruncated INTEGER, createdutc TEXT NOT NULL, completedutc TEXT);",
                ...
                "CREATE TABLE IF NOT EXISTS ingestionjobevents (" +
                    ...
                    "durationms DOUBLE PRECISION, createdutc TEXT NOT NULL);",

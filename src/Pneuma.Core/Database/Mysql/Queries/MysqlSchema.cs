    ...
    internal static class MysqlSchema
    {
        ...
        internal static List<SchemaMigration> Migrations
        {
            get
            {
                ...
                {
                    "ALTER TABLE subjects ADD COLUMN publishedforchat INT NOT NULL DEFAULT 1;",
                ...
                list.Add(new SchemaMigration(17, "Add subject chunking configuration", new List<string>
                {
                    ...
                    "ALTER TABLE subjects ADD COLUMN chunkmaxtokens INT NOT NULL DEFAULT 256;",
                    "ALTER TABLE subjects ADD COLUMN chunkoverlaptokens INT NOT NULL DEFAULT 32;"
                }));
                list.Add(new SchemaMigration(18, "Add subject reranker type", new List<string>
                {
                    "ALTER TABLE subjects ADD COLUMN rerankertype VARCHAR(64) NOT NULL DEFAULT 'LlmListwise';"
                }));
                list.Add(new SchemaMigration(19, "Add model runner provider-specific fields", new List<string>
                {
                    ...
                    "ALTER TABLE modelrunners ADD COLUMN contextsize INT NOT NULL DEFAULT 0;"
                }));
                list.Add(new SchemaMigration(20, "Add per-subject prompt overrides", new List<string>
                {
                    "CREATE TABLE IF NOT EXISTS subjectprompts (" +
                        "id VARCHAR(64) PRIMARY KEY, tenantid VARCHAR(64) NOT NULL, subjectid VARCHAR(64) NOT NULL, promptkey VARCHAR(128) NOT NULL, " +
                        "content TEXT, mergemode VARCHAR(16) NOT NULL DEFAULT 'Append', createdutc VARCHAR(32) NOT NULL, lastupdateutc VARCHAR(32) NOT NULL, " +

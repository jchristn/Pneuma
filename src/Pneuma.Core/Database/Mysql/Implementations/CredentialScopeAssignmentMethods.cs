namespace Pneuma.Core.Database.Mysql.Implementations
{
    ...
    /// <summary>MySQL credential scope assignment methods.</summary>
    internal class CredentialScopeAssignmentMethods : MysqlMethodsBase, ICredentialScopeAssignmentMethods
    {

namespace Pneuma.Core.Integrations.Implementations
{
    ...
    /// (DocumentAtom, RecallDB, LiteGraph) returns a non-success status after any retries are
    ...
    public class IntegrationClientException : Exception
    {
        ...
        /// <summary>Logical service name (for example "documentatom", "recalldb", "litegraph").</summary>
